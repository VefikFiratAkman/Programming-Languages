...
;; This function takes a list, an element and a index. Function put the number to given index in list.
;; And don't overwrite on index.
	(cond 
		((> index 0) (cons (car liste) (insert-n (cdr liste) number (1- index) )))
		((= index 0) (cons number liste))
		((null liste) (return-from insert-n liste))
	);; İn this condition, Function take list's elemant one by one.
  ;; And function put number at index's turn.
